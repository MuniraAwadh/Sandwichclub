...
public class DetailActivity extends AppCompatActivity {
    ...
    private TextView mAlso_known_tv;
    private TextView mIngredients_tv;
    private TextView mDescription_tbe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDescription_tbe= (TextView) findViewById(R.id.description_tv);
    ...
    private void populateUI(Sandwich sandwich) {
       ...
       for(int f=0;f< sandwich.getAlsoKnownAs().size();f++){
           mAlso_known_tv.append(sandwich.getAlsoKnownAs().get(f));
       }
        for(int i=0;i< sandwich.getIngredients().size();i++){
            mIngredients_tv.append(sandwich.getIngredients().get(i));
        }
        mDescription_tbe.setText(sandwich.getDescription());
